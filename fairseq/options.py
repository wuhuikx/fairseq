...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--calib', action='store_true', help='perform int8 calibration')
    parser.add_argument('--int8', action='store_true', help='perform int8 inference')
    parser.add_argument('--engine', default='fbgemm', type=str, help='choose the engine')
